      ...
      <main className={styles.contact}>
        <header className={styles.header_container}>
          <h1 className={styles.header_h2}>
            <span>//</span> Vamos <span>Conversar</span>
          </h1>

          <p className={styles.header_paragraph}>
            Lucas Martins de Barros Torres | Técnico em Refrigeração e Climatização
          </p>
          <p className={styles.header_paragraph}>
            Rua Mascarenhas de Morais, Qd.181 Lt.33 - CEP 74943-500 | CNH A/B | Veículo próprio
          </p>
          <p className={styles.header_paragraph}>
            Telefone/WhatsApp: (62) 9 8529-6795 | Email: pf.lucasmartins@gmail.com
          </p>
